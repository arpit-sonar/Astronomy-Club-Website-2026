...
const eventsData: EventData[] = [
  {
    title: "National Space Week",
    desc: "IIT (BHU) Varanasi celebrates National Space Week annually in August with a series of exciting competitions, workshops, and interactive sessions that bring together students from diverse disciplines to explore the wonders of space science and technology. The 2025 edition, held from 12th-18th August, was graced by Dr. Shyama Narendranath, Senior Scientist at ISRO, as the Chief Guest. Her inspiring words motivated students to dream big and contribute towards India's growing space journey. Through these events, the Institute reaffirms its commitment to nurturing curiosity, fostering innovation, and empowering young minds to take bold steps in the field of space exploration.",
    img: "/nsw.heic",
    link: "https://www.instagram.com/p/DN8WIUAE-Yv/?utm_source=ig_web_button_share_sheet"
  },
  {
    title: "Supernova",
